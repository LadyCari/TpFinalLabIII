...
public class ExamenMalenia {
    ...
    String[] Respuestas1 = {"1-Polimorfismo","1-Polimorfismo","1-Public,Private, Abstracción,Polimorfismo","1-Permite almacenar datos con identificador","1-Public","1-PERO A VOS TE FALLA? COMO NO VAS A DECLARAR UN CONSTRUCTOR","1- Utilizando el método getter","1-Sobreescritura de los métodos por parte de las subclases","1-El compilador buscará el toString default de la superclase object y mostrará la dirección de memoria de los datos","1-Perón (justo después de los derechos laborales)"};
    ...
    String[] Respuestas3 = {"3-Encapsulamiento","3-¿Qué es un pilar? No conozco esa calle","3-Polimorfismo, Abstracción, Encapsulamiento, Herencia","3-Provee herramientas para permitir el desarrollo de aplicaciones con java, además de ser necesario para ejecutar y compilar programas java en cualquier plataforma","3-Protected","3-Puedo instanciar un objeto ya que las clases poseen un constructor predefinido","3-Utilizando el método toString","3-Heredar atributos y métodos a las subclases","3-No existe tal método","3- Moyano y los camioneros"};
    String[] Respuestas4 = {"4-Pilar… Pila? FIFO?","4.Herencia","","4-Interfaces, Estatico, Final, Abstracto","4-JVM? ¿Es algún anime eso?","4-Habrá un error en tiempo de compilación ya que el compilador no identificará ningún constructor de la clase","4-Pidiendo por favor, ser educado siempre es opción","4-Qué le pongo mucho peso al método","4-Explota la pc","4-Bill gates, luego de crear Microsoft"};
    //endregion
